...
const CreatePost = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-[#d19937] text-[32px]">
          Create
        </h1>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          ...
          className= "text-white bg-[#79561c] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">Once you have created the image you want, you can share it others in the community</p>
          <button
          type="Submit"
          className="mt-3 text-white bg-[#d19937] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
